...
path1 = "/nfs/home/ghodsis/Projects/FairNMF/code/data/Pokec/pre_processed/z/"
...
# -------------------------------------------------------------------
features = np.loadtxt(path1 + "Pokec_feature_reg2.csv", delimiter=",", dtype=int)
labels   = np.loadtxt(path1 + "Pokec_label_reg2.csv", delimiter=",", dtype=int)
