...
path = "C:/Users/ghodsis/Desktop/FairNMF/code/data/Pokec/pre_processed/n/"
...
# -------------------------------------------------------------------
labels = np.loadtxt(path + "Pokec_label_reg1.csv", delimiter=",", dtype=int)
...
np.savetxt(path + "Pokec_binary_label_reg1.csv", binary_labels, fmt='%d', delimiter=',')

print("Binarized class labels saved to:", path + "Pokec_binary_label_reg1.csvv")