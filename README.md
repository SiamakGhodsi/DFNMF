...
This repository demonstrates code implementation, instructions, dependencies (i.e., package requirements), and data of the DFNMF model. The paper titled ["A Deep Latent Factor Model for Fairness-Utility Trade-off in Graph Clustering"](https://doi.org/10.48550/arXiv.2510.23507) is accepted in IEEE BigData 2025 Macau.
